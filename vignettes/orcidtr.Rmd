...
Most ORCID data is publicly accessible without authentication. However, authentication provides:

- Higher API rate limits
- Access to private data (if granted permissions)

### Setting Up Authentication

1. Register for ORCID API credentials at [https://orcid.org/developer-tools](https://orcid.org/developer-tools)
2. Obtain your API token (public client credentials)
...
```{r auth-usage}
# The token is automatically detected from environment
works <- orcid_works("0000-0003-4757-117X")
