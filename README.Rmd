...
Most public ORCiD data is accessible without authentication. However, you can optionally use an API token for:
...
The package will automatically detect and use the token. You can also pass tokens explicitly:
