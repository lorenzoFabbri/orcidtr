...
**Note:** The package will automatically use the `ORCID_TOKEN` environment variable if it's set. For the public API, this is purely optional and most users can skip this entire section.
...
Contributions are welcome! Please see the [DEVELOPMENT.md](DEVELOPMENT.md) file for:
